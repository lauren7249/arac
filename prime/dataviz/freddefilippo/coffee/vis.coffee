...
Network = () ->
  ...
  showDetails = (d,i) ->
    ...
    content += '<p class="main">' + d.Entity + '</span></p>'
    content += '<hr class="tooltip-hr">'
    content += '<p class="main" >' + '<img src="https://media.licdn.com/mpr/mpr/shrink_200_200/p/4/000/181/302/1876333.jpg">' +'</span></p>'
    tooltip.showTooltip(content,d3.event)


  # Mouseover tooltip function
  followLink = (d,i) ->
    window.open("https://www.linkedin.com/in/jimplamb");
